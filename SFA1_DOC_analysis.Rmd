...
```{r}
# Import data
rep1.avg=read.csv("~/SFAgrowthrate/SFAphase1/DOC/SFA1_DOC_1-51_processed_summary.csv")
rep2.avg=read.csv("~/SFAgrowthrate/SFAphase1/DOC/SFA1_DOC_52-102_processed_summary.csv")
rep3.avg=read.csv("~/SFAgrowthrate/SFAphase1/DOC/SFA1_DOC_103-153_processed_summary.csv")

# Import metadata
meta=read.csv("~/SFAgrowthrate/SFAphase1/DOC/SFA1_DOC_metadata.csv")
```
