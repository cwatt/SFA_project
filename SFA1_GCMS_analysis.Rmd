...
knitr::opts_knit$set(root.dir = 'home/cassi/SFAgrowthrate/SFAphase1/GCMS/data/')
```
...
dir <- list.dirs(path="~/SFAgrowthrate/SFAphase1/GCMS/data", full.names=TRUE, recursive=FALSE)
...
files <- files[names(files) != "/home/cassi/SFAgrowthrate/SFAphase1/GCMS/data/110119"] 
...
```{r}
# Graph cumulative CO2 and C
graph.CO2 <- ggplot(cumresp.summary.df, aes(x=sample, y=meanCO2)) +
  geom_point() +
...
graph.C <- ggplot(cumresp.summary.df, aes(x=sample, y=meanC)) +
  geom_point() +
