...
```{r}
# Import data
doc = read.csv("~/SFAgrowthrate/SFAphase1.5/DOC/SFA1.5_DOCsummary.csv")

# Import metadata
meta=read.csv("~/SFAgrowthrate/SFAphase1.5/DOC/SFA1.5_DOC_metadata.csv")
...
Data appears normal and has equal variances. Use parametric test: Student's t-test.
...
```{r, results="show"}
# SFA 1 data
load("~/SFAgrowthrate/SFAphase1/r.output/SFA1_DOC.data.RData")
...
Samples 19, 47, 2 very the least between experiments of the high DOC producing communities. Samples 10, 12, 41 for low.
