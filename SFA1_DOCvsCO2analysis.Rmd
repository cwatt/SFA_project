...
knitr::opts_knit$set(root.dir = 'home/cassi/SFAgrowthrate/SFAphase1.5/stdcheck_062220/data')
```
...
# CO2
load("~/SFAgrowthrate/SFAphase1/r.output/SFA1_CO2.data.RData")
...
ggsave("SFA1_DOCCO2.graph.pdf", plot=docco2.biplot, width=6, height=4, units="in", device="pdf")
```
