...
Variable internal standard ASV lengths
--------------------------------------

The internal standard is 292 bp long.

```{r}
asv_lengths <- read_tsv("../data_amplicon/SFA2_nanotest/final/aquifex_seq_lengths.tsv")
