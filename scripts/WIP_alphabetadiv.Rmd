...
```{r}
physeq2 <- subset_samples(physeq, Day==30 & Type=="Headspace")
physeq2
```
...
```{r, eval=FALSE}
ggsave(rich_trt_plot, file="../figures/SFA2_tp30richness.png", units="mm", width=100, height=100)
```
...
```{r}
# Try Bray
bray_dist <- distance(physeq4, method="bray")
ord_bray <- ordinate(physeq4, distance=bray_dist, method="NMDS")
plot_ordination(physeq4, ord, color="DOC") +
  stat_ellipse(type="t")
