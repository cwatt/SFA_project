...
Headspace samples should be removed, cross-contaminated by headspace measurements.

```{r}
physeq3 <- subset_samples(physeq2, Type=="Growth")
physeq3
```
...
Attempt 2 seems to be an improvement in most cases.
...
Divide each taxa count by Aquifex ASV total:
...
Using mbImpute package: https://github.com/ruochenj/mbImpute
