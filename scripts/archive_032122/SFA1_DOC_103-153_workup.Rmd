---
title: "SFA1 - DOC workup samples 103-153, B3"
...
raw = read.csv("~/SFAgrowthrate/SFAphase1/DOC/SFA1_DOC_103-153.csv", fileEncoding = "UTF-8-BOM")
...
write.csv(samples.final[,c(2,3,13)], file ="~/SFAgrowthrate/SFAphase1/DOC/SFA1_DOC_103-153_processed.csv", row.names = FALSE)
write.csv(samples.final.summary, file ="~/SFAgrowthrate/SFAphase1/DOC/SFA1_DOC_103-153_processed_summary.csv", row.names = FALSE)
