...
# TROUBLESHOOT
Why is exponential gain so low?
- one issue is 0s at start of growth, solved: imputed
- fixed replicates not being averaged

I think I underestimated death by a lot, so this analysis probably isn't even valid anyway.
...
- use linear model to predict during growth window, average adjacent for not during growth window?
