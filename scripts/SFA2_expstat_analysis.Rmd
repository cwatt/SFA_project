...
Group 2 start in exp vs stationary:

```{r}
filter(growth_grp, group=="grp2") %>% nrow()
filter(growth_grp, group=="grp2" & start_day < 9) %>% nrow()
filter(growth_grp, group=="grp2" & start_day >= 9) %>% nrow()
```
...
# Group 1 only
cor.test(growth_grp_avg[growth_grp_avg$group=="grp1",]$length, log(growth_grp_avg[growth_grp_avg$group=="grp1",]$change_abund_corr), method="pearson")
...
# Group 1
cor.test(growth_grp_avg[growth_grp_avg$group=="grp1",]$k, log(growth_grp_avg[growth_grp_avg$group=="grp1",]$change_abund_corr), method="pearson")
