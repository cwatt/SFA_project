...
Save preprocessed taxonomy:

```{r, eval=FALSE}
tax <- as.data.frame(tax_table(physeq4))
...
From 1500 to 1000 to 500 reads, lose 56, 38, and 22 samples respectively.

However, I am most interested in days 0, 10, 21, and 30 (early, mid, and late succession) and I am not losing many of those samples at higher depth.
...
Divide each taxon count by Aquifex ASV total in sample:
