...
# PAPRICA outputs
# Bacteria
pap_bac <- read_csv("../paprica_analysis/output_bacteria/growthdeath_rep-seqs.bacteria.edge_data.csv")
place_bac <- read_csv("../paprica_analysis/output_bacteria/growthdeath_rep-seqs.bacteria.combined_16S.bacteria.tax.placements.csv")

# Archaea
pap_arc <- read_csv("../paprica_analysis/output_archaea/growthdeath_rep-seqs.archaea.edge_data.csv")
place_arc <- read_csv("../paprica_analysis/output_archaea/growthdeath_rep-seqs.archaea.combined_16S.archaea.tax.placements.csv")
...
# Pathways
path_bac <- read_csv("../paprica_analysis/output_bacteria/growthdeath_rep-seqs.bacteria.pathways.csv")
path_arc <- read_csv("../paprica_analysis/output_archaea/growthdeath_rep-seqs.archaea.pathways.csv")
```
