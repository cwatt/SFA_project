...
# PAPRICA outputs
# Bacteria
pap_bac <- read_csv("../paprica_analysis/output_bacteria/subset_rep-seqs.bacteria.edge_data.csv")
place_bac <- read_csv("../paprica_analysis/output_bacteria/subset_rep-seqs.bacteria.combined_16S.bacteria.tax.placements.csv")

# Archaea
pap_arc <- read_csv("../paprica_analysis/output_archaea/subset_rep-seqs.archaea.edge_data.csv")
place_arc <- read_csv("../paprica_analysis/output_archaea/subset_rep-seqs.archaea.combined_16S.archaea.tax.placements.csv")
...
acido_n16S <- missing_replace[1,2]
acido_genome <- missing_replace[1,3]
chloro_n16S <- missing_replace[2,2]
chloro_genome <- missing_replace[2,3]
